...
python /home/students/anhtu/qa-rewards-abstractive-summarization/training.py --pretrained_model_path ./finetuning/output_pegasus/checkpoint-1000 --summary_model_name "google_pegasus_xsum" --max_token_len 128 --max_sum_token_len 60
deactivate