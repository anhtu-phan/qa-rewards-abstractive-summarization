...
python /home/students/anhtu/qa-rewards-abstractive-summarization/finetuning/run_summarization.py --model_name_or_path google/pegasus-xsum --per_device_train_batch_size 1 --per_device_eval_batch_size 1 --learning_rate 3e-5 --num_train_epochs 10 --max_source_length 128 --max_target_length 40 --do_train --do_eval --dataset_name xsum --output_dir "/home/students/anhtu/qa-rewards-abstractive-summarization/finetuning/output_pegasus/"
deactivate
